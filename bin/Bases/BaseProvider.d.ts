...
export declare abstract class BaseResource<TInputs, TOutputs> extends pulumi.dynamic
    .Resource {
    protected constructor(provider: BaseProvider<TInputs, TOutputs>, name: string, args: BaseOptions<TInputs & Partial<TOutputs>>, opts?: pulumi.CustomResourceOptions);
}
